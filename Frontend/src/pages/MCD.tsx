      ...
      <Card variant="glass" className="p-3 shrink-0">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-bold text-neutral-900 leading-tight tracking-tight">Master Customer Data</h1>
          ...
          <div className="flex items-center gap-3 border-l border-neutral-200/50 pl-4">
             ...
             <Button 
                ...
                className={cn("h-9 w-40 font-bold shadow-sm transition-all", isAdding ? "bg-neutral-800 hover:bg-neutral-900 text-white" : "bg-brand-600 hover:bg-brand-700 shadow-brand-500/20")}
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-4 min-h-0">
         ...
         <div className={cn("transition-all duration-500 ease-in-out overflow-hidden flex flex-col", isAdding ? "lg:col-span-4 h-full" : "lg:col-span-0 w-0 opacity-0 overflow-hidden hidden")}>
            <Card variant="elevated" className="flex flex-col h-full border-brand-200 shadow-lg shadow-brand-500/5 ring-1 ring-brand-500/10">
               <CardHeader className="py-2.5 px-4 border-b border-neutral-100 bg-brand-50/50 shrink-0">
                  <CardTitle size="sm" className="flex items-center gap-2 text-brand-900">
                     <Building2 className="w-4 h-4 text-brand-600" />
                     Registration Subsystem
                  </CardTitle>
               </CardHeader>
               <CardContent className="flex-1 overflow-y-auto p-5 scrollbar-thin bg-white relative">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
                     <div className="space-y-2">
                        ...
                        <div className="relative">
                           ...
                           <Input
                              ...
                              className="w-full h-11 pl-10 rounded-xl border-2 border-neutral-100 bg-neutral-50/50 focus:bg-white text-sm font-medium shadow-sm transition-all outline-none focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10"
                              value={formData.name} 
                     ...
                     <div className="space-y-2">
                        ...
                        <div className="relative">
                           ...
                           <Input
                              ...
                              className="w-full h-11 pl-10 rounded-xl border-2 border-neutral-100 bg-neutral-50/50 focus:bg-white text-sm font-medium font-mono shadow-sm transition-all outline-none focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10"
                     ...
                     <div className="space-y-2">
                        ...
                        <select 
                           className="block w-full h-11 px-4 rounded-xl border-2 border-neutral-100 bg-neutral-50/50 focus:bg-white text-sm font-medium text-neutral-800 shadow-sm focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 transition-all outline-none appearance-none"
                     ...
                     <div className="space-y-2">
                        ...
                        <div className="relative flex">
                           ...
                           <textarea 
                              ...
                              rows={3}
                              className="block w-full pl-10 pr-4 py-3 rounded-xl border-2 border-neutral-100 bg-neutral-50/50 focus:bg-white text-sm font-medium shadow-sm transition-all outline-none resize-none focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10"
                     ...
                     <div className="pt-2">
                        <Button type="submit" size="lg" className="w-full h-12 text-sm font-bold shadow-md shadow-brand-500/20" leftIcon={<Save className="w-4 h-4" />}>
                           COMMIT RECORD
                        </Button>
                     </div>
                  </form>
         ...
         <Card variant="elevated" className={cn("flex flex-col h-full overflow-hidden transition-all duration-500", isAdding ? "lg:col-span-8" : "col-span-1 lg:col-span-12")}>
            <CardHeader className="py-2.5 px-4 border-b border-neutral-100 bg-neutral-50/50 shrink-0">
               <div className="flex items-center justify-between">
                  ...
                  <Badge variant="primary" size="sm" className="bg-brand-100 text-brand-700 border-brand-200">
                     {filteredCustomers.length} Active Records
                  </Badge>
               </div>
            </CardHeader>

            <CardContent className="flex-1 p-0 flex flex-col relative bg-white overflow-hidden">
               <div className="flex-1 overflow-auto scrollbar-thin">
                  <table className="w-full text-left border-collapse min-w-[800px]">
                     <thead className="bg-white/95 backdrop-blur-md border-b border-neutral-200 sticky top-0 z-20 shadow-sm">
                        <tr>
                     ...
                     <tbody className="divide-y divide-neutral-100/60 bg-white">
                        {filteredCustomers.map((c, idx) => (
                           ...
                           >
                              <td className="py-4 px-5">
                                 <div className="flex items-center gap-3">
                                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-brand-50 to-brand-50 border border-brand-100 flex items-center justify-center text-brand-700 font-black text-sm shadow-sm">
                                       {c.name.charAt(0).toUpperCase()}
                                    </div>
                                    <div>
                                       <span className="font-bold text-neutral-900 block text-sm">{c.name}</span>
                              ...
                              <td className="py-4 px-5">
                                 <div className="space-y-1.5">
                                    <div className="flex items-center text-xs text-neutral-600 font-medium font-mono">
                              ...
                              <td className="py-4 px-5 text-center">
                                 {c.ownership === 'Self' ? (
                                    <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-success-50/50 border border-success-200 text-success-700 rounded-full font-bold text-[10px] tracking-widest uppercase">
                                       <span className="w-1.5 h-1.5 rounded-full bg-success-500"></span> Direct (Self)
                                    </div>
                                 ) : (
                                    <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-warning-50/50 border border-warning-200 text-warning-700 rounded-full font-bold text-[10px] tracking-widest uppercase">
                                       <span className="w-1.5 h-1.5 rounded-full bg-warning-500"></span> 3rd Party
                                    </div>
                                 )}
                              </td>
                              <td className="py-4 px-5">
                                 <div className="flex items-start text-xs text-neutral-600 max-w-[200px] leading-relaxed">
                              ...
                              <td className="py-4 px-5 text-right">
                                 <Button variant="ghost" size="sm" className="opacity-0 group-hover:opacity-100 transition-all font-bold h-8 text-brand-600 hover:bg-brand-50" rightIcon={<ChevronRight className="w-4 h-4" />}>
                                    Manage
                                 </Button>
                              </td>
                           </tr>
                           ...
                           <tr>
                              <td colSpan={5} className="py-32">
                                 <div className="flex flex-col items-center justify-center text-center animate-in zoom-in-95 duration-500">
                                    <div className="w-24 h-24 bg-white shadow-sm ring-1 ring-neutral-200 rounded-full flex items-center justify-center mb-6 relative group overflow-hidden">
                                    ...
                                    <h3 className="text-xl font-heading font-bold text-neutral-900 mb-2">Empty Trading Directory</h3>
